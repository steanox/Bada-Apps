...
class ConfettiEmitter{
    ...
    private let imageSet: [UIImage] = [#imageLiteral(resourceName: "IconArrowUp"),#imageLiteral(resourceName: "confetti.png"),#imageLiteral(resourceName: "Circle"),#imageLiteral(resourceName: "Box")]
