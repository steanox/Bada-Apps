...
class ConfettiEmitter{
    ...
    private let imageSet: [UIImage] = [#imageLiteral(resourceName: "Triangle"),#imageLiteral(resourceName: "Spiral"),#imageLiteral(resourceName: "Circle"),#imageLiteral(resourceName: "Box")]
