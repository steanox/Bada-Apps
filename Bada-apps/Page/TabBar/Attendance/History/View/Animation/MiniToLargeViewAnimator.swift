...
class MiniToLargeViewAnimator: BaseAnimator {
    ...
    func fakeMiniView() -> UIView {
        ...
        let dragableHistoryView: UIView = UIView(frame: CGRect(x: 0.0, y: 0.0, width: UIScreen.main.bounds.size.width, height: 40.0))
        dragableHistoryView.backgroundColor = .red
        
        return dragableHistoryView
    }
